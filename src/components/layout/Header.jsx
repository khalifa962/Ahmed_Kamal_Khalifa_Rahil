...
queryCat=gql`{categories{
name
}}`

componentDidMount(){
  request("http://localhost:4000",this.queryCat).then((data)=>{
    return setTimeout(()=>{
    ...
    <Fragment>
      ...
      <ul>
        {this.state.categories.map(c=>{
          return  <Link key={c.name} style={{textDecoration:"none", color:"black"}} to={`/${c.name} `}>
                    <li onClick={this.props.categoryHandler} className={this.props.categoryName==="all"?style.active:null}>{c.name}</li>
                  </Link>
        })}
      </ul>
      <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_150_1419)">
      ...
      <path d="M36.0988 34.6014C36.1313 34.9985 35.8211 35.339 35.4268 35.339H5.59438C5.2009 35.339 4.89092 35.0002 4.92208 34.6037L7.06376 7.34717C7.09168 6.9927 7.38426 6.71973 7.73606 6.71973H33.1958C33.5468 6.71973 33.8391 6.99161 33.868 7.34499L36.0988 34.6014Z" fill="url(#paint0_linear_150_1419)"/>
      ...
      <defs>
      <linearGradient id="paint0_linear_150_1419" x1="29.8733" y1="31.3337" x2="11.5132" y2="9.9008" gradientUnits="userSpaceOnUse">
      <stop stopColor="#52D67A"/>
      <stop offset="1" stopColor="#5AEE87"/>
      </linearGradient>
      <clipPath id="clip0_150_1419">
      <rect width="31.16" height="30.176" fill="white" transform="translate(4.91992 5.41211)"/>
      </clipPath>
      </defs>
      </svg>

        <HeaderCartButton returnCurrnFun={this.props.returnCurrnFun} showCartHandler={this.props.showCartHandler} />
      </header>
    </Fragment>
  )
}
